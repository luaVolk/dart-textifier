  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    Stream: {
      ...
      get$first: function(_) {
        ...
        t1.subscription = W._EventStreamSubscription$(this._html$_target, this._eventType, t3, false, t2);
        return future;
      }
    },
    ...
    Textifier: {
      ...
      write$3: function(url, el, append) {
        var t1, onError, t2, t3, result;
        t1 = this.createCharacters$2(0, url).then$1$1(new U.Textifier_write_closure(false, el), W.Node);
        onError = new U.Textifier_write_closure0();
        t2 = H.getTypeArgumentByIndex(t1, 0);
        t3 = $.Zone__current;
      ...
      write$2: function(url, el) {
        return this.write$3(url, el, false);
      }
    },
    ...
    Textifier_write_closure: {
      "^": "Closure:21;append,el",
      call$1: function(html) {
        var finale;
        H.assertSubtype(html, "$isList", [P.String], "$asList");
        if (!this.append)
          J.setInnerHtml$1$x(this.el, "");
        finale = document.createElement("pre");
        J.setInnerHtml$2$validator$x(finale, J.join$1$ax(html, ""), $.VALIDATOR);
        return J.append$1$x(this.el, finale);
      }
    },
    Textifier_write_closure0: {
      "^": "Closure:2;",
      call$1: function(error) {
    ...
    "^": "",
    main: function() {
      var t1, t2, textifier, pre, rect, width, height, t3, target;
      t1 = document;
      t2 = t1.createElement("canvas");
      H.interceptedTypeCheck(t2, "$isCanvasElement");
      textifier = new U.Textifier(1 / 0, 1 / 0, "01", "#00000000", false, 0, t2);
      textifier.ctx = H.interceptedTypeCheck(C.CanvasElement_methods.getContext$1(t2, "2d"), "$isCanvasRenderingContext2D");
      pre = t1.createElement("pre");
      t2 = pre.style;
      t2.display = "inline";
      pre.textContent = " ";
      t2 = t1.body;
      (t2 && C.BodyElement_methods).append$1(t2, pre);
      rect = pre.getBoundingClientRect();
      width = rect.width;
      height = rect.height;
      J.remove$0$x(pre);
      t2 = P.String;
      textifier.set$font(0, P.LinkedHashMap_LinkedHashMap$_literal(["ratio", height / width, "width", width, "height", height], t2, P.num));
      t3 = H.setRuntimeTypeInfo([], [W.NodeValidator]);
      C.JSArray_methods.add$1(t3, W._Html5NodeValidator$(null));
      C.JSArray_methods.add$1(t3, W._TemplatingNodeValidator$());
      C.JSArray_methods.add$1(t3, W._SimpleNodeValidator$(null, H.setRuntimeTypeInfo(["*::style"], [t2]), null, null));
      $.VALIDATOR = new W.NodeValidatorBuilder(t3);
      target = C.HtmlDocument_methods.getElementById$1(t1, "target");
      J.addEventListener$2$x(C.HtmlDocument_methods.querySelector$1(t1, "form"), "submit", new A.main_closure(target, textifier));
    },
    main_closure: {
      "^": "Closure:22;target,textifier",
      call$1: function(e) {
        ...
        t3.write$2(H.interceptedTypeCast(C.HtmlDocument_methods.getElementById$1(t2, "piggies"), "$isImageElement").src, t1);
      }
    },
    main__closure: {
      "^": "Closure:3;",
...
;
  ...
  $ = new Isolate();
  init.metadata = [];
  init.types = [{func: 1, ret: P.Null}, {func: 1, ret: -1}, {func: 1, ret: P.Null, args: [,]}, {func: 1, ret: P.int, args: [P.String]}, {func: 1, ret: -1, args: [{func: 1, ret: -1}]}, {func: 1, args: [,]}, {func: 1, ret: P.bool, args: [W.NodeValidator]}, {func: 1, ret: P.bool, args: [P.String]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, ret: P.Null, args: [{func: 1, ret: -1}]}, {func: 1, ret: P.Null, args: [,], opt: [,]}, {func: 1, ret: [P._Future,,], args: [,]}, {func: 1, ret: P.Null, args: [,,]}, {func: 1, ret: P.bool, args: [W.Node]}, {func: 1, args: [W.Event]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: -1, args: [W.Node, W.Node]}, {func: 1, ret: [P.Map, P.String,,], args: [W.Event]}, {func: 1, ret: [P.List, P.String], args: [[P.Map, P.String,,]]}, {func: 1, ret: W.Node, args: [[P.List, P.String]]}, {func: 1, ret: P.Null, args: [W.Event]}];
