...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    Textifier: {
      ...
      draw$2: function(url, el) {
        return this.draw$3(url, el, false);
      }
    },
    ...
    main: function() {
      ...
      J.addEventListener$2$x(C.HtmlDocument_methods.querySelector$1(t1, "form"), "submit", new U.main_closure(target, textifier));
    },
    main_closure: {
      ...
      call$1: function(e) {
        ...
        if (typeof maxHeight === "string") {
          t3 = P.int_parse(maxHeight, new U.main__closure(), null);
          if (typeof t3 !== "number")
            return t3.$lt();
        ...
        if (typeof maxWidth === "string") {
          t3 = P.int_parse(maxWidth, new U.main__closure0(), null);
          if (typeof t3 !== "number")
            return t3.$lt();
        ...
        t3 = this.textifier;
        t3.color = P.int_parse(J.toString$0$(H.interceptedTypeCast(C.HtmlDocument_methods.getElementById$1(t2, "color"), "$isSelectElement").value), new U.main__closure1(), null);
        ...
        t3.draw$2(H.interceptedTypeCast(C.HtmlDocument_methods.getElementById$1(t2, "piggies"), "$isImageElement").src, t1);
      }
    },
    main__closure: {
      "^": "Closure:3;",
