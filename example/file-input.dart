...
main() {
  ...
  FileUploadInputElement fileInput = document.getElementById('file');

  fileInput.addEventListener('change', (Event e) {

    FileReader reader = new FileReader();

    reader.onLoad.first.then((Event event) {
        file = reader.result;
    });
  ...
  document.querySelector('form').addEventListener('submit', (Event e) {
    ...
    textifier.draw(file, target, false);
  });
}
